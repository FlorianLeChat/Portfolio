	...
	foreach ($plateforms_data as $plateform)
	{
		...
		$plateforms_html .= "
			<a href=\"$url\" style=\"color: $color\" title=\"$name\" target=\"_blank\">
				<img src=\"assets/images/platforms/$identifier.svg\" width=\"32\" height=\"32\" draggable=\"false\" alt=\"Image - $name\" decoding=\"async\" />
			</a>
		";
	}
?>
...
<header>
	...
	<!-- Vagues de fin -->
	<img src="assets/images/decorations/header_waves_blue.svg" alt="" decoding="async" />
</header>